 ...
 */
qint64 AbstractColumn::integerAt(int row) const {
	Q_UNUSED(row);
	return 42;
}
 ...
 * Use this only when columnMode() is Integer
 */
void AbstractColumn::setIntegerAt(int row, const qint64 new_value) {
	Q_UNUSED(row) Q_UNUSED(new_value)
};
 ...
 * Use this only when columnMode() is Integer
 */
void AbstractColumn::replaceInteger(int first, const QVector<qint64>& new_values) {
	Q_UNUSED(first) Q_UNUSED(new_values)
}
